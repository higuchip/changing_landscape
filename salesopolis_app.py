...
original_title = '<h1 style="color:Blue"> Mudanças na ocupação territorial em Salesópolis no período de 1985 a 2020  </h1>'
st.markdown(original_title, unsafe_allow_html=True)
subtitle = "<h3> Aplicação para a visualização de mudanças na cobertura e uso do solo</h3>"
...
st.warning(
    'Atenção: Desenvolvimento experimental, com o propósito didático.')
st.markdown("___")
...
# Importar de geobr
lages = read_municipality(code_muni=3545001, year=2020)
...
legend_dict = {legend_keys[i]: legend_colors[i]
...
Map.centerObject(roi_lages, zoom=11)
